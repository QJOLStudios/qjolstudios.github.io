...
const siteData = deserializeFunctions(JSON.parse(`{"lang":"en-US","dir":"ltr","title":"QJOL Studios","description":"QJOL Studios' website","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"主页","link":"/"},{"text":"产品","link":"/products"},{"text":"团队","link":"/team"},{"text":"下载中心","link":"/download"},{"text":"抽卡分析","link":"/gacha-analyzer"},{"text":"用户中心","link":"/user"}],"sidebar":[{"text":"导航","items":[{"text":"所有产品","link":"/products"},{"text":"团队","link":"/team"},{"text":"下载中心","link":"/download"},{"text":"抽卡分析","link":"/gacha-analyzer"},{"text":"用户中心","link":"/user"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/QJOLStudios/"}]},"locales":{},"scrollOffset":134,"cleanUrls":false}`));

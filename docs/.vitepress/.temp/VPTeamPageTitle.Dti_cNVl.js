...
import { a as useData$1, f as isExternal, t as treatAsHtml, w as withBase, g as isActive, h as getScrollOffset, o as onContentUpdated, E as EXTERNAL_URL_RE, u as useRoute, i as inBrowser } from "./Content.Dc2Ksrw_.js";
...
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-1168a8e4><a class="title"${ssrRenderAttr("href", link.value ?? unref(normalizeLink$1)(unref(currentLang).link))}${ssrRenderAttr("rel", rel.value)}${ssrRenderAttr("target", target.value)} data-v-1168a8e4>`);
